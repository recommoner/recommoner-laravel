    ...
    b = function () {
        function c(c, d) {
            ...
            e.defaults = {
                ...
                '<img src="/images/arrow-left.png" alt=""></button>',
                nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"><img src="/images/arrow-right.png" alt=""></button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
